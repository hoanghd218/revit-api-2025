...
namespace RevitAddIn1.Bai5EdittingCreating.MovingElement
{
    [UsedImplicitly]
    [Transaction(TransactionMode.Manual)]
    public class MoveOneElementCmd : ExternalCommand
    {
        public override void Execute()
        {
            ...
            {
                tx.Start();
                ElementTransformUtils.MoveElement(Document,column.Id,new XYZ(10.MetToFeet(),0,0));
